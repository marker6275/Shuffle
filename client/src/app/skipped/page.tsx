    ...
    <div className="flex flex-col items-center justify-center p-8 gap-4">
      ...
      {Object.entries(skippedSongs).length > 0 && (
        <div className="flex items-center justify-center gap-4 w-full md:w-128">
          <div
            className="flex flex-col items-center justify-center py-4 px-3 bg-green-500 rounded-lg w-full cursor-pointer hover:bg-green-600"
          ...
          <div
            className="flex flex-col items-center justify-center py-4 px-3 bg-red-500 rounded-lg w-full cursor-pointer hover:bg-red-600"
            onClick={clearSkippedSongs}
          >
            <h1 className="text-xs md:text-xl font-bold text-white">
              Clear skipped songs
            </h1>
      ...
      {showConfirmScreen && (
        <div className="bg-white fixed w-screen h-screen flex items-center justify-center top-0 left-0">
          <div className="flex flex-col items-center justify-center gap-4 p-6">
            ...
            <div className="flex items-center justify-center gap-4 w-full md:w-128">
              <button
                className="flex flex-col items-center justify-center p-4 w-30 md:w-50 md:h-16 bg-green-500 rounded-lg cursor-pointer hover:bg-green-600"
                onClick={() => handleConfirm(1)}
              >
                Yes
              </button>
              <button
                className="flex flex-col items-center justify-center p-4 w-30 md:w-50 md:h-16 bg-red-500 rounded-lg cursor-pointer hover:bg-red-600"
